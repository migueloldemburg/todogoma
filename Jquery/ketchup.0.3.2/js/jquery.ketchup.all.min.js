...
jQuery.ketchup.validation("required","Debe completar este campo.",function(g,b,c){g=b.attr("type").toLowerCase();return g=="checkbox"||g=="radio"?b.attr("checked")==true:c.length!=0}).validation("minlength","Este campo debe tener un m\u00ednimo de caracteres ({arg1}).",function(g,b,c,d){return c.length>=+d}).validation("maxlength","This field must have a maximal length of {arg1}.",function(g,b,c,d){return c.length<=+d}).validation("rangelength","Este campo debe tener un m\u00ednimo y m\u00e1ximo  de {arg1} y {arg2}.",function(g,
