...
.validation('required', 'Debe completar este campo.', function(form, el, value) {
...
.validation('minlength', 'Este campo debe tener un m\u00ednimo de caracteres ({arg1}).', function(form, el, value, min) {
...
.validation('rangelength', 'Este campo debe tener un m\u00ednimo y m\u00e1ximo  de {arg1} y {arg2}.', function(form, el, value, min, max) {
